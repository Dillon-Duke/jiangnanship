...
public class AppBaseMsgServiceImpl extends ServiceImpl<AppBaseMsgMapper, AppBaseMsg> implements AppBaseMsgService {
    ...
    public Map<String, String> appLunch(AppBaseMsg appBaseMsg) throws NoSuchAlgorithmException {
        ...
        return MapUtils.getMap("uuid",uuid,"publicKey",integerStringMap.get("公钥"));
