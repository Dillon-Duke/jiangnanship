...
import com.caidao.wapper.FastDfsClientWrapper;
 ...
 * @author tom
 */
public class FdfsUpAndDowUtils  {

    @Autowired
    private FastDfsClientWrapper fastDFSClientWrapper;

    private final Logger logger = LoggerFactory.getLogger(FdfsUpAndDowUtils.class);
